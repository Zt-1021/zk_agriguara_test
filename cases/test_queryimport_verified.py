...
@pytest.mark.parametrize("args", ymal_util.yamlUtil("../data/queryimport_verified.yaml").read_yaml())
class TestQueryImport(object):
    def test_passorderlist(self, begin_02, set_global_data,get_global_data, env_vars,args):
        """
...
if __name__ == '__main__':
    ...
    pytest.main(["-ra", '-v', '-x', '-m test_queryimport',
